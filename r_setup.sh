...
# install.packages(c(
#   "tidyverse", "data.table", "dplyr", "ggplot2", "readr", "purrr",
#   "stringr", "lubridate", "MatrixModels", "quantreg", "car", "alr4",
#   "rio", "caret", "glmnet", "lme4", "nlme", "survival", "reshape2",
#   "forcats", "haven", "magrittr", "plotly", "RColorBrewer"
# ), dependencies = TRUE)